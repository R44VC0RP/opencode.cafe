    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-md border border-[var(--color-border)] bg-[var(--color-bg)] p-6",
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-lg font-semibold leading-none text-[var(--color-text-strong)]",
        className
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-sm text-[var(--color-text-weak)]", className)}
      {...props}
    />
  )
}
